...
!function (e, n) {
  ...
  return function (e) {
    ...
    function t(e) {
      ...
      if (n && "number" != typeof n.line && "number" != typeof n.column) throw new Error("original.line and original.column are not numbers -- you probably meant to omit the original mapping entirely and only map the generated position. If so, pass null for the original mapping instead of an object with empty or null values.");if ((!(e && "line" in e && "column" in e && e.line > 0 && e.column >= 0) || n || r || t) && !(e && "line" in e && "column" in e && n && "line" in n && "column" in n && e.line > 0 && e.column >= 0 && n.line > 0 && n.column >= 0 && r)) throw new Error("Invalid mapping: " + JSON.stringify({ generated: e, source: r, original: n, name: t }));
    ...
    function t(e) {
      ...
      var t,
          ...
          g = 0,
          p = 0;do {
        if (n >= c) throw new Error("Expected more digits in base 64 VLQ value.");if (a = i.decode(e.charCodeAt(n++)), a === -1) throw new Error("Invalid base64 digit: " + e.charAt(n - 1));t = !!(a & l), a &= u, g += a << p, p += s;
    ...
    var r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");n.encode = function (e) {
      if (0 <= e && e < r.length) return r[e];throw new TypeError("Must be between 0 and 63: " + e);
    }, n.decode = function (e) {
      var n = 65,
          r = 90,
          t = 97,
          ...
          u = 47,
          l = 26,
          c = 52;return n <= e && e <= r ? e - n : t <= e && e <= o ? e - t + l : i <= e && e <= s ? e - i + c : e == a ? 62 : e == u ? 63 : -1;
    };
  }, function (e, n) {
    function r(e, n, r) {
      ...
      if (!e) return !1;var n = e.length;if (n < 9) return !1;if (95 !== e.charCodeAt(n - 1) || 95 !== e.charCodeAt(n - 2) || 111 !== e.charCodeAt(n - 3) || 116 !== e.charCodeAt(n - 4) || 111 !== e.charCodeAt(n - 5) || 114 !== e.charCodeAt(n - 6) || 112 !== e.charCodeAt(n - 7) || 95 !== e.charCodeAt(n - 8) || 95 !== e.charCodeAt(n - 9)) return !1;for (var r = n - 10; r >= 0; r--) {
    ...
    function t() {
      this._array = [], this._set = s ? new Map() : Object.create(null);
        ...
        s = "undefined" != typeof Map;t.fromArray = function (e, n) {
      ...
      var r = s ? e : o.toSetString(e),
          ...
          a = this._array.length;t && !n || this._array.push(e), t || (s ? this._set.set(e, a) : this._set[r] = a);
    }, t.prototype.has = function (e) {
      if (s) return this._set.has(e);var n = o.toSetString(e);return i.call(this._set, n);
    }, t.prototype.indexOf = function (e) {
      if (s) {
        var n = this._set.get(e);if (n >= 0) return n;
      } else {
        var r = o.toSetString(e);if (i.call(this._set, r)) return this._set[r];
    ...
    function t(e) {
    ...
    }, t.prototype._version = 3, t.prototype.__generatedMappings = null, Object.defineProperty(t.prototype, "_generatedMappings", { get: function get() {
        return this.__generatedMappings || this._parseMappings(this._mappings, this.sourceRoot), this.__generatedMappings;
      } }), t.prototype.__originalMappings = null, Object.defineProperty(t.prototype, "_originalMappings", { get: function get() {
      ...
      var n = a.getArg(e, "line"),
        ...
        var i = this._originalMappings[o];if (void 0 === e.column) for (var s = i.originalLine; i && i.originalLine === s;) {
          t.push({ line: a.getArg(i, "generatedLine", null), column: a.getArg(i, "generatedColumn", null), lastColumn: a.getArg(i, "lastGeneratedColumn", null) }), i = this._originalMappings[++o];
      ...
      var n = Object.create(o.prototype),
          ...
          t = n._sources = l.fromArray(e._sources.toArray(), !0);n.sourceRoot = e._sourceRoot, n.sourcesContent = e._generateSourcesContent(n._sources.toArray(), n.sourceRoot), n.file = e._file;for (var s = e._mappings.toArray().slice(), u = n.__generatedMappings = [], c = n.__originalMappings = [], p = 0, h = s.length; p < h; p++) {
        var f = s[p],
    ...
    }, o.prototype._version = 3, Object.defineProperty(o.prototype, "sources", { get: function get() {
      ...
      for (var r, t, o, s, u, l = 1, p = 0, h = 0, f = 0, d = 0, m = 0, _ = e.length, v = 0, y = {}, C = {}, A = [], S = []; v < _;) {
        if (";" === e.charAt(v)) l++, v++, p = 0;else if ("," === e.charAt(v)) v++;else {
          for (r = new i(), r.generatedLine = l, s = v; s < _ && !this._charIsMappingSeparator(e, s); s++) {}if (t = e.slice(v, s), o = y[t]) v += t.length;else {
            for (o = []; v < s;) {
              c.decode(e, v, C), u = C.value, v = C.rest, o.push(u);
            }if (2 === o.length) throw new Error("Found a source, but no line and column");if (3 === o.length) throw new Error("Found a source and line, but no column");y[t] = o;
    ...
    }, n.BasicSourceMapConsumer = o, s.prototype = Object.create(t.prototype), s.prototype.constructor = t, s.prototype._version = 3, Object.defineProperty(s.prototype, "sources", { get: function get() {
      ...
      for (var n = 0; n < this._sections.length; n++) {
        var r = this._sections[n];if (r.consumer.sources.indexOf(a.getArg(e, "source")) !== -1) {
      ...
      this.__generatedMappings = [], this.__originalMappings = [];for (var r = 0; r < this._sections.length; r++) {
    ...
    function r(e, t, o, i, s, a) {
      var u = Math.floor((t - e) / 2) + e,
          l = s(o, i[u], !0);return 0 === l ? u : l > 0 ? t - u > 1 ? r(u, t, o, i, s, a) : a == n.LEAST_UPPER_BOUND ? t < i.length ? t : -1 : u : u - e > 1 ? r(e, u, o, i, s, a) : a == n.LEAST_UPPER_BOUND ? u : e < 0 ? -1 : e;
    }n.GREATEST_LOWER_BOUND = 1, n.LEAST_UPPER_BOUND = 2, n.search = function (e, t, o, i) {
      if (0 === t.length) return -1;var s = r(-1, t.length, e, t, o, i || n.GREATEST_LOWER_BOUND);if (s < 0) return -1;for (; s - 1 >= 0 && 0 === o(t[s], t[s - 1], !0);) {
        --s;
      }return s;
    };
  }, function (e, n) {
    function r(e, n, r) {
      ...
      if (i < s) {
        var a = t(i, s),
            u = i - 1;r(e, a, s);for (var l = e[s], c = i; c < s; c++) {
          n(e[c], l) <= 0 && (u += 1, r(e, u, c));
        }r(e, u + 1, c);var g = u + 1;o(e, n, i, g - 1), o(e, n, g + 1, s);
      }
    ...
    function t(e, n, r, t, o) {
      ...
      function o(e, n) {
        ...
        function e() {
          ...
          g = 1,
          p = 0,
          h = null;return n.eachMapping(function (e) {
        if (null !== h) {
          if (!(g < e.generatedLine)) {
            var n = u[l],
                r = n.substr(0, e.generatedColumn - p);return u[l] = n.substr(e.generatedColumn - p), p = e.generatedColumn, o(h, r), void (h = e);
          }o(h, c()), g++, p = 0;
        }for (; g < e.generatedLine;) {
          a.add(c()), g++;
        }if (p < e.generatedColumn) {
          var n = u[l];a.add(n.substr(0, e.generatedColumn)), u[l] = n.substr(e.generatedColumn), p = e.generatedColumn;
        }h = e;
      ...
      for (var n, r = 0, t = this.children.length; r < t; r++) {
        n = this.children[r], n[u] ? n.walk(e) : "" !== n && e(n, { source: this.source, line: this.line, column: this.column, name: this.name });
      }
      ...
      var n = { code: "", line: 1, column: 0 },
        ...
        n.code += e, null !== o.source && null !== o.line && null !== o.column ? (i === o.source && s === o.line && u === o.column && l === o.name || r.addMapping({ source: o.source, original: { line: o.line, column: o.column }, generated: { line: n.line, column: n.column }, name: o.name }), i = o.source, s = o.line, u = o.column, l = o.name, t = !0) : t && (r.addMapping({ generated: { line: n.line, column: n.column } }), i = null, t = !1);for (var c = 0, g = e.length; c < g; c++) {
          e.charCodeAt(c) === a ? (n.line++, n.column = 0, c + 1 === g ? (i = null, t = !1) : t && r.addMapping({ source: o.source, original: { line: o.line, column: o.column }, generated: { line: n.line, column: n.column }, name: o.name })) : n.column++;
        }
