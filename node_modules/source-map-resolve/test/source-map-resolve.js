...
var code = {
  ...
  dataUri: u("data:application/json," + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D"),
  base64: u("data:application/json;base64," + "eyJtYXBwaW5ncyI6IkFBQUEiLCJzb3VyY2VzIjpbImZvby5qcyJdLCJuYW1lcyI6W119"),
  dataUriText: u("data:text/json," + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D"),
  dataUriParameter: u("data:application/json;charset=UTF-8;foo=bar," + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D"),
  dataUriNoMime: u("data:,foo"),
  dataUriInvalidMime: u("data:text/html,foo"),
  dataUriInvalidJSON: u("data:application/json,foo"),
  dataUriXSSIsafe: u("data:application/json," + ")%5D%7D%27" + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D"),
  dataUriEmpty: u("data:"),
  noMap: ""
};
...
function testResolveSourceMap(method, sync) {
  return function (t) {
    ...
    t.equal(typeof method === "undefined" ? "undefined" : _typeof(method), "function", "is a function");
    ...
    method(code.dataUri, codeUrl, wrap(Throws), function (error, result) {
      t.error(error);
      t.deepEqual(result, {
        sourceMappingURL: "data:application/json," + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D",
        url: null,
    ...
    method(code.dataUriText, codeUrl, wrap(Throws), function (error, result) {
      t.error(error);
      t.deepEqual(result, {
        sourceMappingURL: "data:text/json," + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D",
        url: null,
        sourcesRelativeTo: codeUrl,
        map: map.simple
      }, "dataUriText");
    ...
    method(code.dataUriParameter, codeUrl, wrap(Throws), function (error, result) {
      t.error(error);
      t.deepEqual(result, {
        sourceMappingURL: "data:application/json;charset=UTF-8;foo=bar," + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D",
        url: null,
        sourcesRelativeTo: codeUrl,
        map: map.simple
      }, "dataUriParameter");
    ...
    method(code.dataUriInvalidJSON, codeUrl, wrap(Throws), function (error, result) {
      ...
      t.ok(error instanceof SyntaxError && error.message !== "data:application/json,foo", "dataUriInvalidJSON");
      t.notOk(result);
      isAsync();
    });
    ...
    method(code.dataUriXSSIsafe, codeUrl, wrap(Throws), function (error, result) {
      t.error(error);
      t.deepEqual(result, {
        sourceMappingURL: "data:application/json," + ")%5D%7D%27" + "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" + "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D",
        url: null,
        sourcesRelativeTo: codeUrl,
        map: map.simple
      }, "dataUriXSSIsafe");
...
function testResolveSources(method, sync) {
  return function (t) {
    ...
    method(map.sourceRoot, mapUrl, wrap(identity), function (error, result) {
      t.error(error);
      t.deepEqual(result, {
        sourcesResolved: ["http://example.com/static/js/app/foo.js", "http://example.com/static/js/app/lib/bar.js", "http://example.com/static/js/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"],
        sourcesContent: ["http://example.com/static/js/app/foo.js", "http://example.com/static/js/app/lib/bar.js", "http://example.com/static/js/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"]
      }, "sourceRoot");
      isAsync();
    });
    ...
    method(map.sourceRoot, mapUrl, wrap(identity), options, function (error, result) {
      t.error(error);
      t.deepEqual(result, {
        sourcesResolved: ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"],
        sourcesContent: ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"]
      }, "ignore sourceRoot");
      isAsync();
    });
    ...
    method(map.sourceRoot, mapUrl, wrap(identity), options, function (error, result) {
      t.error(error);
      t.deepEqual(result, {
        sourcesResolved: ["http://example.com/static/js/foo.js", "http://example.com/static/js/lib/bar.js", "http://example.com/static/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"],
        sourcesContent: ["http://example.com/static/js/foo.js", "http://example.com/static/js/lib/bar.js", "http://example.com/static/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"]
      }, "custom sourceRoot");
      isAsync();
    });
    ...
    method(map.mixed, mapUrl, wrap(identity), function (error, result) {
      ...
      t.deepEqual(result, {
        sourcesResolved: ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"],
        sourcesContent: ["foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "/version.js", "//foo.org/baz.js"]
      }, "mixed");
      isAsync();
    });
    ...
    method(map.mixed, mapUrl, wrap(Throws), function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "read throws .sourcesResolved");
      ...
      t.deepEqual(sourcesContent, ["foo.js", null, null, "/version.js", "//foo.org/baz.js"], "read throws .sourcesContent");
      isAsync();
    });
...
function testResolve(method, sync) {
  return function (t) {
    var wrap = sync ? identity : asyncify;
    var wrapMap = function wrapMap(mapFn, fn) {
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourceRoot), function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/static/js/app/foo.js", "http://example.com/static/js/app/lib/bar.js", "http://example.com/static/js/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourceRoot");
      t.deepEqual(result.sourcesContent, ["http://example.com/static/js/app/foo.js", "http://example.com/static/js/app/lib/bar.js", "http://example.com/static/js/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourceRoot");
      isAsync();
    });
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourceRoot), options, function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "ignore sourceRoot");
      t.deepEqual(result.sourcesContent, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "ignore sourceRoot");
      isAsync();
    });
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourceRoot), options, function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/static/js/foo.js", "http://example.com/static/js/lib/bar.js", "http://example.com/static/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "custom sourceRoot");
      t.deepEqual(result.sourcesContent, ["http://example.com/static/js/foo.js", "http://example.com/static/js/lib/bar.js", "http://example.com/static/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "custom sourceRoot");
      isAsync();
    });

    method(code.fileRelative, codeUrl, readMap(map.sourceRootNoSlash), function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/static/js/app/foo.js", "http://example.com/static/js/app/lib/bar.js", "http://example.com/static/js/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourceRootNoSlash");
      t.deepEqual(result.sourcesContent, ["http://example.com/static/js/app/foo.js", "http://example.com/static/js/app/lib/bar.js", "http://example.com/static/js/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourceRootNoSlash");
      isAsync();
    });

    method(code.fileRelative, codeUrl, readMap(map.sourceRootEmpty), function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourceRootEmpty");
      t.deepEqual(result.sourcesContent, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourceRootEmpty");
      isAsync();
    });

    method(code.fileRelative, codeUrl, readMap(map.sourcesContent), function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/static/js/app/foo.js", "http://example.com/static/js/app/lib/bar.js", "http://example.com/static/js/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourcesContent");
      t.deepEqual(result.sourcesContent, ["foo.js", "lib/bar.js", "../vendor/dom.js", "/version.js", "//foo.org/baz.js"], "sourcesContent");
      isAsync();
    });

    method(code.fileRelative, codeUrl, readMap(map.mixed), function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "mixed");
      t.deepEqual(result.sourcesContent, ["foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "/version.js", "//foo.org/baz.js"], "mixed");
      isAsync();
    });
    ...
    method(null, mapUrl, readMap(map.sourceRoot), options, function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/static/js/foo.js", "http://example.com/static/js/lib/bar.js", "http://example.com/static/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "mapUrl custom sourceRoot");
      t.deepEqual(result.sourcesContent, ["http://example.com/static/js/foo.js", "http://example.com/static/js/lib/bar.js", "http://example.com/static/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "mapUrl custom sourceRoot");
      isAsync();
    });

    method(null, mapUrl, readMap(map.mixed), function (error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "mapUrl mixed");
      t.deepEqual(result.sourcesContent, ["foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "/version.js", "//foo.org/baz.js"], "mapUrl mixed");
      isAsync();
    });
